...
const invoiceSchema = new Schema<InvoiceDocument>({
    purchaseId: {
        ...
        unique: true,
        default: crypto.randomUUID(), /* SOLILOQUY:  I think it's better to move this calculation to the mongoose query pre("save") instead*/
    },
    buyer: {
...
const Invoice = models?.Invoice || model<InvoiceDocument, InvoiceModel>("Invoice", invoiceSchema);
