...
import { RankingDocument } from "@/Types/Ranking";
import { StoreBasic } from "@/Types/Store";
...
const Ranking = models?.Ranking || model<RankingDocument, RankingModel>("Ranking", rankingSchema);
