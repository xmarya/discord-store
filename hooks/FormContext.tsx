...
import { ContextProps, StatusCode } from "@/_Types/FormContext"
...
function FormContextProvider({children, formAction}:Props) {
    const inputsValidStatus = useRef<Record<string, StatusCode>>({});
    ...
    function register(name:string) {
        ...
        return (code:StatusCode) => {
            ...
            console.log("return (code:StatusCode) =>  inputsValidStatus", inputsValidStatus);
            checkValidity();
        }
    }
